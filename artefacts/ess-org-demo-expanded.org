...
#+BEGIN_EXPORT html
<em>Tips for using this document</em>
<blockquote>
You are looking at this on the web, and I hope you find it useful.
<p>
But, a useful method of using this file to learn is to download
<a href="https://ess-intro.github.io/presentation-org-mode/artefacts/ess-org-demo-expanded.org">
the plain text .org file</a>, open it in Emacs, and explore it,
editing and/or evaluating the various blocks provided, seeing what
they do, changing things, trying again, how did it change -- all those
pedagogical techniques.  (If you somehow mess up, you can always
