...
[[https://www.youtube.com/playlist?list=PLVtKhBrRV_ZkPnBtt_TD1Cs9PJlU0IIdE][Rainer's screencasts about Org mode]] ([[https://www.udemy.com/course/getting-yourself-organized-with-org-mode/?referralCode=D0CB0D077ED5EC0788F7][a course on Udemy]])
...
*** for each subtree in the buffer

- if some property, export to html
- if some property, export to latex
- if some property, export to pdf
(where "if some property" means at that level; ancestor level will
be/was covered when walked gets there.)
