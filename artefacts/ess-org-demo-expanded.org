...
In particular, there is an e-mail list, an IRC channel, etc.  The [[https://ess.r-project.org/index.php?Section=home][ESS
project]] also has ways to connect, listed [[https://ess.r-project.org/index.php?Section=getting%20help][here]].
